...
import com.pfb.common.util.PropertiesHelperUtil;
 ...
 * @author 于增佳
 * @since 2013-6-17 上午9:39:06
 */

@Intercepts({ @Signature(type = Executor.class, method = "query", args = {
		MappedStatement.class, Object.class, RowBounds.class,
		ResultHandler.class }) })
public class DialectPaginationInterceptor implements Interceptor {
...
//		builder.keyProperty(ms.getKeyProperty());
	...
	public void setProperties(Properties properties) {
		String dialectClass = new PropertiesHelperUtil(properties)
		...
		System.out.println(DialectPaginationInterceptor.class.getSimpleName()
